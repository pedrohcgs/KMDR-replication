...
*7-26-02 This program creates the base91 dataset from SIPP ascii files;
*Only variables relevant for this project are retained;
*Some variables renamed at the end and binary response vars recoded;
*datasets: original sipp extracts must be unzipped into sip91w*.dat temp files, 
*and base91 is output;
...
!pkunzip /home/data/sipp/1991/sipp91wX.zip \ !mv sipp91wX.dat sipp91wX.raw \ 
log close \ do sip91wX \
	...
	famrel nkidshl\
save ~/scratch1/91wX, replace \ log close \ 
rm sipp91wX.raw \ clear;

log using extract, append;

use ~/scratch1/91w1;
for num 2/8: append using ~/scratch1/91wX;
...
save ~/bulk/base91, replace;

for num 1/8: rm ~/scratch1/91wX.dta;
