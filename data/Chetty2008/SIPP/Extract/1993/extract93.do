...
*7-26-02 This program creates the base93 dataset from SIPP ascii files;
*Only variables relevant for this project are retained;
*Some variables renamed at the end and binary response vars recoded;
*datasets: original sipp extracts must be unzipped into sip93w*.dat temp files, 
and base93 is output;
...
!pkunzip /home/data/sipp/1993/sipp93wX.zip \ !mv sipp93wX.dat sipp93wX.raw \ 
log close \ do sip93wX \
	...
	famrel nkidshl\
save ~/scratch1/93wX, replace \ log close \ 
rm sipp93wX.raw \ clear;

log using extract, append;

use ~/scratch1/93w1;
for num 2/9: append using ~/scratch1/93wX;
...
save ~/bulk/base93, replace;

for num 1/9: rm ~/scratch1/93wX.dta;
