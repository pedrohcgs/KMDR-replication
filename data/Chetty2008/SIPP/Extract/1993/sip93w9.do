log using sip93w9, replace
set mem 400m
*This program reads the 1993 SIPP Wave 9 Core Data File 
*by Jean Roth Thu Jul 25 15:20:01 EDT 2002
*Please report errors to jroth@nber.org
*run with do sip93w9
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1993\sip93w9.raw"
* The following changes in variable names have been made, if necessary:
*      '$' to 'd';            '-' to '_';              '%' to 'p';
*      ($ = unedited data;     - = edited data;         % = allocated data)
* Note:  Variable names in Stata are case-sensitive
clear
quietly infile using sip93w9
...
label define P101L   
	1           "Interview month: October 1995" 
	2           "Interview month: November 1995"
	3           "Interiew month: December 1995" 
	4           "Interview month: January 1996" 
;
