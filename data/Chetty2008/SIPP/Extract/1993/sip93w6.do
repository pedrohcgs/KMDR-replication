log using sip93w6, replace
set mem 400m
*This program reads the 1993 SIPP Wave 6 Core Data File 
*by Jean Roth Thu Jul 25 15:14:46 EDT 2002
*Please report errors to jroth@nber.org
*run with do sip93w6
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1993\sip93w6.raw"
* The following changes in variable names have been made, if necessary:
*      '$' to 'd';            '-' to '_';              '%' to 'p';
*      ($ = unedited data;     - = edited data;         % = allocated data)
* Note:  Variable names in Stata are case-sensitive
clear
quietly infile using sip93w6
...
label define P106L   
	...
	7120        "Salinas-Seashide-Monterey, CA" 
	7160        "Salt Lake City-Ogden, UT"      
	7240        "San Antonio, TX"               
	7320        "San Diego, CA"                 
	7480        "Santa Barbara-Santa Monica, CA"
...
label define P215L   
	...
	7           "Persian Gulf War"              
	8           "Other service (all other periods)"
	9           "Not answered"                  
;
...
label define P697L   
	...
	3           "Individual husband-wife benefits,"
...
label define P701L   
	...
	3           "Other"                         
;
label values ssicovrg P702L;  
label define P702L   
	0           "Not in universe"               
	1           "Adult(s)"                      
	2           "Child(ren)"                    
	3           "Both adult(s) and child(ren)"  
;
