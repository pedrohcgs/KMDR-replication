...
*files, and t4asset92 is output;

log using t4asset92, replace
...
*decode certain vars to missing val from 0;

log close;
set logtype text;
log using miss-val-t492.txt, replace;
