...
*files, and t7asset93 is output;

log using t7asset93, replace
...
!pkunzip /home/data/sipp/1993/sipp93t$X.zip
...
rename tm8761 MVeh2DebtAmnt 
rename tm8768 OtherMVeh2YN 
rename tm8734 MVeh3Year 
rename tm8758 MVeh3DebtYN 
rename tm8762 MVeh3DebtAmnt 
...
keep suseqnum suid state pinx pnum a_wave tmcarva1 tmcarva2 tmcarva3 hh_mortg hh_theq hh_vehcl hh_beq hh_intbk hh_intot hh_stk
...
Mrtg1PrincOwed Mrtg1YearObtaind Mrtg1MnthObtaind Mrtg1OrgnlAmnt Mrtg1NumYearsPymt Mrtg1APR Mrtg1OtherMrtgYN Mrtg2PrincOwed
Mrtg2YearObtaind Mrtg2MnthObtaind Mrtg2OrgnlAmnt Mrtg2NumYearsPymt Mrtg2APR ProptyCurrVal ResSubsdYN OwnOthRealEstYN
TValOthRealEst OwnVehYN HNumVeh MVeh1Year MVeh1DebtYN MVeh1DebtAmnt OtherMVeh1YN MVeh2Year MVeh2DebtYN MVeh2DebtAmnt
OtherMVeh2YN MVeh3Year MVeh3DebtYN MVeh3DebtAmnt;

*decode the 0's in certain vars to missing values;

log close;
set logtype text;
log using miss-val-t793.txt, replace;
