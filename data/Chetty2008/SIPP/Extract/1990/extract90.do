...
*7-12-02 This program creates the base90 dataset from SIPP ascii files;
*Only variables relevant for this project are retained;
*Some variables renamed at the end and binary response vars recoded;
*datasets: original sipp extracts must be unzipped into sip90w*.dat temp files, 
and base90 is output;
...
!pkunzip /home/data/sipp/1990/sipp90wX.zip \ !mv sipp90wX.dat sipp90wX.raw \ 
log close \ do sip90wX \
	...
	famrel nkidshl\
save ~/scratch1/90wX, replace \ log close \ 
rm sipp90wX.raw \ clear;

log using extract, append;

use ~/scratch1/90w1;
for num 2/8: append using ~/scratch1/90wX;
...
save ~/bulk/base90, replace;

for num 1/8: rm ~/scratch1/90wX.dta;
